...
public class TileView extends View {
    ...
    //numero di pixel formati dalla griglia di gioco sugli assi x e y
    ...
    /**
     * A hash that maps integer handles specified by the subclasser to the drawable-anim that will be
     ...
     * @param tile
     */
    //disegna risorse drawable
    public void loadTile(int key, Drawable tile) {
        Bitmap bitmap = Bitmap.createBitmap(mTileSize, mTileSize, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(bitmap);
        //setta dimensione risorse drawable
    ...
    //disegna la risorsa apple
    public void loadTileApple(int key, Drawable tile) {
        Bitmap bitmap = Bitmap.createBitmap(mTileSize, mTileSize, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(bitmap);
        //setta dimensione mele
    ...
    //ripristina l'array per disgenare i pixel
     ...
     * @param y
     */
    //metodo che setta i pixel lungo gli assi x e y
    public void setTile(int tileindex, int x, int y) {
        mTileGrid[x][y] = tileindex;
    }

    //calcola dimesioni schermo e adatta il gioco al dispositivo
    @Override
