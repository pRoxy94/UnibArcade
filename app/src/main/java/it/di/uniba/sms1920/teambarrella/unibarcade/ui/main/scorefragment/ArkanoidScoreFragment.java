...
public class ArkanoidScoreFragment extends ListFragment {
    ...
    private final String TAG = "ArkanoidScoreFragment";
    private ListView arkanoidScoresList;

    public ArkanoidScoreFragment() {}

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        arkanoidScoresList = getListView();
    }
    ...
    public void onStart() {
        ...
        textColor = getActivity().getResources().getColor(R.color.colorAccentArkanoid, null);
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    for (String nick : nickname.keySet()) {
                        ...
                        String score = dataSnapshot.child("nickname/" + nick + "/game/2").getValue(String.class);
                ...
                arkanoidScoresList.setAdapter(scoreArrayAdapter);
            }
    ...
    public static ArkanoidScoreFragment newInstance() {

        Bundle args = new Bundle();

        ArkanoidScoreFragment fragment = new ArkanoidScoreFragment();
