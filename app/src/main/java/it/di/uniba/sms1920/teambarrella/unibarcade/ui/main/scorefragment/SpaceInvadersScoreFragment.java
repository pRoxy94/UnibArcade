 ...
 */
public class SpaceInvadersScoreFragment extends ListFragment {
    ...
    private final String TAG = "SpaceInvadersScoreFragm";
    private ListView spaceInvadersScoresList;

    public SpaceInvadersScoreFragment() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        spaceInvadersScoresList = getListView();
    }
    ...
    public void onStart() {
        ...
        textColor = getActivity().getResources().getColor(R.color.colorAccentSpaceInvaders, null);
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    for (String nick : nickname.keySet()) {
                        ...
                        String score = dataSnapshot.child("nickname/" + nick + "/game/3").getValue(String.class);
                ...
                spaceInvadersScoresList.setAdapter(scoreArrayAdapter);
            }
    ...
    public static SpaceInvadersScoreFragment newInstance() {
        Bundle args = new Bundle();
        SpaceInvadersScoreFragment fragment = new SpaceInvadersScoreFragment();
